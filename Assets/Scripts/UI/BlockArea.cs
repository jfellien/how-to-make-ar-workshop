    ...
    public class BlockArea : MonoBehaviour
    {
        ...
        void ApplyBlockArea(Rect r)
        {
            ...
            if (Screen.width > 0 && Screen.height > 0)
            {
                ...
                var blockHeight = r.position + r.size;

                var anchorMax = r.height > 0 ? Vector2.one : Vector2.zero;

                anchorMin.x = 0;
                anchorMin.y = r.height > 0 ? blockHeight.y / Screen.height : 0;
